...
- The strait's significance is changing — more energy bypasses it each year, but the shock value of any incident grows with the world's tightening spare capacity.
</KeyTakeaways>
...
<WhyItMatters>
The strait is the point where the region's politics become the world's inflation. Every confrontation near it is transmitted instantly to every household budget, which is why it will never be allowed to become routine — and why it keeps being tested.
</WhyItMatters>
