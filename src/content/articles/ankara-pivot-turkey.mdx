...
heroImageAlt: "Ortaköy Mosque on the shore of the Bosphorus, Istanbul"
imageCredit: "Ortaköy Mosque on the Bosphorus. Giuseppe Pinto, CC BY-SA 3.0."
readingTime: 7
sources:
...
- The logic of the pivot is economic and political survival — and the diversification of every dependency.
...
<TheBigPicture>
Turkey has made its geography into its strategy, converting a position between two worlds into a permanent negotiation. The strategy works until the world forces a choice — and the signs are accumulating that both poles are, slowly, preparing to demand one.
</TheBigPicture>
